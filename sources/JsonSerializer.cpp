...
void JsonSerializer::saveBashHistory(std::vector<ExecutedCommand>& history) {
...
void JsonSerializer::saveFilesystemHistory(std::vector<ChangedFile>& history) {
  std::string home = getenv("HOME");
...
void JsonSerializer::saveVimCommandsHistory(std::vector<VimCommand>& history) {
  std::string home = getenv("HOME");
